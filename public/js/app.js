...
if (document.URL.includes("ditiseen.test/js-two")) {
  window.onload = function () {
    ...
    addToDoButton.addEventListener('click', function () {
      ...
      var paragraph = document.createElement('p'); //______________________Sets_innerText_to_value_of_inputField___//
    ...
    var app = Vue.createApp({
      data: function data() {
        return {
          ...
          author: 'Sun Tzu',
          persons: [{
            name: 'Maurice di Tolve',
            profession: 'Junior Front End Developer',
            city: 'Groningen',
            img: '/images/vue-one_persons/mauricedt.png'
          }, {
            name: 'Rick Grimes',
            profession: 'Zombie Apocalypse Survivor',
            city: 'Atlanta',
            img: '/images/vue-one_persons/rickgrimes.png'
          }, {
            name: 'Jon Snow',
            profession: 'King in the North',
            city: 'Winterfell',
            img: '/images/vue-one_persons/jonsnow.png'
          }],
          x: 0,
          y: 0
        };
